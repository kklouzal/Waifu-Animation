export type { AnimationClip, AnimationTrack, ClipValidationIssue, NormalizedTrackProperty, SampleOptions, SampleRatioOptions, SampleRepairDiagnostic, TrackProperty } from "./clip-internal.js";
