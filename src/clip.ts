import { type Quat, type Transform, type Vec3, EPSILON, ONE_VEC3, addVec3, cloneQuat, cloneTransform, cloneVec3, clamp, dotQuat, ensureShortestQuat, euclideanModulo, lerpVec3, multiplyQuat, normalizeQuat, slerpQuat, transformDelta } from "./math.js";
import { mat4Translation } from "./numeric-helpers.js";
import { defaultTrackSample, formatClipIssue, normalizedTrackProperty, pushRotationSampleRepairDiagnostic, readClipTimeRatio, readTrackTargetKey, repairVec3Sample, resolveTrackJointIndex, retargetSampledRotation, rotationSampleFallback, trackStride, validateClip } from "./clip-internal.js";
