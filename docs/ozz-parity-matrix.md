...
1. Aim IK plus two-bone IK parity: implement an Ozz-style aim IK correction job and fill two-bone job gaps for mid-axis, twist, soften, weight, and model-matrix inputs. This unlocks full look-at and foot-ankle alignment parity.
